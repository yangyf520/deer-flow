...
export const enUS: Translations = {
  ...
  agents: {
    ...
    knowledgeHint: "Choose which knowledge spaces this agent can search",
    knowledgeEmptyHint: "No spaces yet — create one in Knowledge first",
    knowledgeMetaNone: "None mounted",
    openKnowledge: "Open Knowledge",
    mountAllOpen: "Mount all",
    unmountAllOpen: "Unmount all",
    fieldKnowledgeScenario: "Scenario",
    knowledgeScenarioHint: "Showing only spaces bound to “{scenario}”",
    knowledgeScenarioEmpty: "No spaces bound to “{scenario}”",
