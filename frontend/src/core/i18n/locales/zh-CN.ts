...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    soulGenerate: "AI 生成",
    soulGenerateHint: "通过对话一步步生成 SOUL，确认后写入下方表单。",
    soulGenerating: "生成中…",
    soulGenerateError: "生成 SOUL 失败",
    soulGenerated: "已生成 SOUL，请检查后保存",
    soulDraftPageTitle: "AI 生成个人设定",
    soulDraftBootstrapMessage:
      "智能体名称是 {name}。{descriptionPart}请通过对话帮我设计 SOUL.md（个人设定）。不要调用 setup_agent 保存智能体，只专注设计 SOUL。",
    soulDraftDescriptionPart: "功能描述：{description}。",
    soulDraftFinishMessage:
      "请根据我们目前的全部讨论，输出最终的 SOUL.md 正文。只输出 Markdown 内容，用 ```markdown 代码块包裹，不要调用任何工具。",
    soulDraftConfirm: "确认 SOUL",
    soulDraftConfirmTitle: "确认个人设定",
    soulDraftConfirmHint: "确认后将写入表单，你仍可在保存前继续编辑。",
