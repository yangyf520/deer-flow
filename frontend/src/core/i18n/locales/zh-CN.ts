...
export const zhCN: Translations = {
  ...
  agents: {
    ...
    createPageSubtitle: "填写名称与描述，配置个人设定、模型与知识库。",
    editPageTitle: "编辑智能体",
    editPageSubtitle: "修改配置后保存即可生效。",
    notFound: "找不到该智能体",
    nameStepTitle: "给新智能体起个名字",
    nameStepHint:
      "只允许字母、数字和连字符，存储时自动转为小写（例如 code-reviewer）",
    nameStepPlaceholder: "例如 code-reviewer",
    settingsNamePlaceholder: "字母、数字、连字符，如 code-reviewer",
    nameStepContinue: "继续",
    ...
    descriptionPlaceholder: "简要说明这个智能体做什么",
    soulTitle: "个人设定",
    soulHint: "人格、原则与行为边界（Markdown）",
    soulGenerate: "AI 生成",
    soulGenerating: "生成中…",
    ...
    knowledgeTitle: "知识挂载",
    knowledgeBoundCount: "已挂载 {bound} / {total}",
    knowledgeHint: "选择该智能体可检索的知识空间",
    knowledgeEmptyHint: "还没有可用空间，先去知识库创建一个",
    knowledgeMetaNone: "未挂载",
    openKnowledge: "打开知识库",
    mountAllOpen: "全部挂载",
    unmountAllOpen: "全部取消",
    fieldKnowledgeScenario: "检索场景",
    knowledgeScenarioHint: "仅显示绑定「{scenario}」的空间",
    knowledgeScenarioEmpty: "暂无绑定「{scenario}」的空间",
    scenarioInherit: "默认",
    createAgent: "创建智能体",
  ...
  knowledge: {
    title: "知识库",
    description: "管理空间、绑定检索场景、上传与召回评测",
    createSpace: "新建空间",
    mySpaces: "我的空间",
    spaceCount: "{count} 个空间",
    emptySpaces: "还没有空间，点右上角「新建空间」添加",
    ...
    fieldAccess: "可见性",
    fieldScenario: "检索场景",
    fieldAllowedKinds: "允许类型",
    allAllowedKinds: "全部类型",
    selectAllowedKinds: "选择允许的文档类型",
    fieldKind: "文档类型",
    fieldKindHint: "决定切块与检索策略",
    editTags: "标签",
    uploadTagsHint: "可选，用于多路召回过滤",
    filterAllKinds: "全部类型",
    selectKind: "筛选类型",
    namePlaceholder: "policy-reviewer",
    descriptionPlaceholder: "法务审计",
    selectScenario: "选择场景",
    bindScenario: "绑定场景",
    documents: "文档",
    eval: "召回评测",
    grants: "授权",
    agentSpacesUnbound: "尚未挂载任何空间，保存后该智能体无法检索企业知识",
    grantsUpstreamHint: "主体 id 来自上游组织，此处不做目录校验",
    deleteGrantTooltip: "删除该授权",
    docsSubtitle: "上传文档并查看解析进度",
    docsList: "文档列表",
    docsCount: "{count} 篇",
    docsCountFiltered: "{filtered} / {total} 篇",
    searchFilename: "搜索文件名…",
    upload: "上传文档",
    uploading: "上传中…",
    emptyDocs: "还没有文档，点击此处上传第一份文件",
    noMatchingDocs: "没有匹配的文件",
    viewChunks: "查看分片",
    reindex: "重建",
    reindexing: "重建中…",
    reindexTooltip: "重新选择文件并解析向量化",
    deleteTooltip: "删除文档并移除向量索引",
    deleting: "删除中…",
    dedupedNotice: "该文件已在库中，未重复入库",
    chunks: "分片",
    chunksSummary: "共 {count} 个检索分片",
    chunksLoading: "加载分片中…",
    chunksEmpty: "暂无分片（文档未就绪，或索引尚未写入 docstore）",
    searchChunks: "搜索分片…",
    searchChunksEmpty: "没有匹配的分片",
    charCount: "{count} 字",
    emptyText: "（空）",
    access: {
      open: "全员可读",
    ...
    parseQualityHint: {
      ok: "主解析路径成功（Docling）",
      degraded:
        "主解析失败，已降级为简易解析；复杂表格/版式可能不完整，建议重建或换源文件",
      failed: "解析失败，文档不可检索",
    },
    evalTitle: "召回评测",
    evalDescription:
      "每道问题单独检索；超过 {count} 条默认收起，可查看耗时、来源与正文",
    questionPlaceholder: "用户问题",
    deleteQuestion: "删除此题",
    addQuestion: "加一题",
    topKPrefix: "取前",
    topKSuffix: "条",
    ...
    emptySnippet: "（空内容）",
    noHits: "无命中",
    hitsSummary: "{count} 条 · 最高分 {score}",
    docsInvolved: "{count} 篇文档",
    scoreGap: "分差 {gap}",
    emptyRecallHint:
      "这题没有匹配到知识片段（库内无相关内容，或被相似度阈值滤掉）",
    collapseHidden: "收起后 {count} 条",
    expandHidden: "展开其余 {count} 条",
    questionsCount: "{count} 题",
    totalLatency: "总耗时 {latency}",
    avgLatency: "平均 {latency}/题",
    hitChunks: "命中片段 {count}",
    docsTouched: "涉及文档 {count}",
    emptyRecallCount: "空召回 {count} 题",
    lowTopCount: "低分置顶 {count} 题",
    grantsTitle: "授权",
    grantsSpace: "空间 {id}",
    addGrant: "添加 / 更新授权",
    subjectType: "主体类型",
  ...
  toolCalls: {
    ...
    structuredResult: (schemaHint: string) => `结构化结果（${schemaHint}）`,
    viewStructuredResult: "查看 JSON 结果",
  },
  ...
  auth: {
    login: {
      subtitleSignIn: "登录你的账号",
      subtitleSignUp: "创建新账号",
      email: "邮箱",
  ...
  settings: {
    ...
    apiKeys: {
      title: "API 密钥",
      description: "创建密钥、绑定智能体、脚本与集成调用",
      fieldName: "密钥名称",
      fieldAgent: "绑定智能",
      fieldDescription: "备注说明",
      namePlaceholder: "输入密钥名称",
      descriptionPlaceholder: "输入备注（可选）",
      agentPlaceholder: "绑定 Agent（可选）",
      noAgentBinding: "不绑定 Agent",
      unboundAgent: "未绑定智能体",
      leadAgent: "主 Agent（默认）",
      createButton: "创建密钥",
      creating: "创建中...",
      createdTitle: "请立即复制 API 密钥",
      createdHint: "密钥仅显示一次，请妥善保存。",
      copyButton: "复制密钥",
      myKeys: "我的密钥",
      keyCount: "{count} 个密钥",
      ...
      deleteTitle: "撤销 API 密钥",
      deleteDescription:
        "撤销后该密钥将立即失效，使用它的脚本或集成将无法继续访问。",
      revoking: "撤销中...",
